...
define('CONDO360WS_VERSION', '1.0.0-debug');
...
class Condo360WhatsAppPluginDebug {
    ...
    public function enqueue_scripts() {
        ...
        // Usar script de depuración
        wp_enqueue_script(
            'condo360ws-script',
            CONDO360WS_PLUGIN_URL . 'assets/script-debug.js',
            array('jquery'),
            CONDO360WS_VERSION,
            true
        );
    ...
    public function shortcode_wa_connect_qr($atts) {
        ...
        <div class="condo360ws-container" data-auto-refresh="<?php echo esc_attr($atts['auto_refresh']); ?>" data-refresh-interval="<?php echo esc_attr($atts['refresh_interval']); ?>">
            <div class="condo360ws-header">
                <h3><?php _e('Estado de WhatsApp (DEBUG)', 'condo360ws'); ?></h3>
            ...
            <div style="margin-top: 20px; padding: 10px; background: #f0f0f0; border-radius: 4px; font-size: 12px;">
                ...
                Plugin Version: <?php echo CONDO360WS_VERSION; ?><br>
    ...
    public function add_admin_menu() {
        add_options_page(
            __('Condo360 WhatsApp (Debug)', 'condo360ws'),
            __('WhatsApp Service (Debug)', 'condo360ws'),
            'manage_options',
            'condo360ws-settings-debug',
    ...
    public function admin_page() {
        ...
        ?>
        <div class="wrap">
            <h1><?php _e('Configuración de Condo360 WhatsApp Service (DEBUG)', 'condo360ws'); ?></h1>
